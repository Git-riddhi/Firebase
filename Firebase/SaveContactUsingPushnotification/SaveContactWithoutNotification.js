...
export default function SaveContactWithoutNotification() {

  // Background message handling without display notification 
  messaging().setBackgroundMessageHandler(async (remoteMessage) => {
    ...
    if (remoteMessage.data.title && remoteMessage.data.body) {
      const personName = remoteMessage.data.title;
      const contactNumber = remoteMessage.data.body;
