...
import { GOOGLE_MAP_KEY } from '../Tracking/Constants/googleMapKey';
// import imagePath from '../constants/imagePath';
import MapViewDirections from 'react-native-maps-directions';
import Loader from '../Tracking/Components/Loader';
import { locationPermission, getCurrentLocation } from '../Tracking/helperFunction';
...
const Home = ({ navigation }) => {
    ...
    const onPressLocation = () => {
        navigation.navigate('Choose Location', { getCordinates: fetchValue })
    }
